...
namespace TestingValidationsZ
{
    ...
    public class TestSimplified
    {
        ...
        public void ValidateSimplified()
        {
            ...
            var simplified = SimplifiedExpression.Process(1,null,str);
            ...
            simplified = SimplifiedExpression.Process(1,null,str);
            ...
            string str2=null;
            simplified = SimplifiedExpression.Process(1,null,str2);
            simplified.SymbolExpressionFinal.Equals("");
            simplified.TermExpressions.Count.Equals(0);
